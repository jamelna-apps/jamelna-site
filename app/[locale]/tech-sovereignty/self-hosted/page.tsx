...
const UDLSection = ({ udl }: { udl: UDLFramework }) => {
  ...
  return (
    <div className="bg-canvas-deep border border-primary/30 rounded-lg overflow-hidden">
      <button
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2 flex-wrap">
              ...
              <span className="text-xs px-2 py-1 rounded-full bg-canvas-deep text-text-muted">
                {project.duration}
              </span>
            </div>
      ...
      <section className="pt-10 pb-8 px-6 bg-canvas-deep">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-terra-light text-sm font-medium">Track B</span>
          </div>
          <h1 className="text-display-section font-display font-extrabold text-text-heading mb-4">Self-Hosted Services</h1>
