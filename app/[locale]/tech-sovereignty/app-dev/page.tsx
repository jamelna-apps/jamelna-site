...
const CorePrinciple = () => (
  <div className="bg-canvas-raised border border-terra/30 rounded-xl p-6 mb-8">
    <div className="flex items-start gap-4">
      ...
      <div>
        <h3 className="font-display text-lg font-bold text-text-heading mb-2">Core Pedagogical Principle: Building for Community</h3>
        ...
        <div className="grid md:grid-cols-3 gap-4 mt-4">
          <div className="bg-canvas-deep rounded-lg p-4 border border-canvas-border">
            <h4 className="font-semibold text-terra-light mb-1">Problem-First Thinking</h4>
            <p className="text-sm text-text-muted">Start with real problems, not technology. The best solutions come from understanding actual needs.</p>
          </div>
          <div className="bg-canvas-deep rounded-lg p-4 border border-canvas-border">
            <h4 className="font-semibold text-terra-light mb-1">Iterative Development</h4>
            <p className="text-sm text-text-muted">Build small, test often, improve continuously. Perfect is the enemy of good enough to help.</p>
          </div>
          <div className="bg-canvas-deep rounded-lg p-4 border border-canvas-border">
            <h4 className="font-semibold text-terra-light mb-1">Sustainable Solutions</h4>
            <p className="text-sm text-text-muted">Create tools others can understand, maintain, and adapt. Individual heroics don&apos;t scale.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <main className="min-h-screen bg-canvas">
      ...
      <div className="bg-canvas-deep border-t border-canvas-border">
        <div className="max-w-6xl mx-auto px-4 py-6 flex justify-between">
          <Link href={`/${locale}/tech-sovereignty/ai-llm`} className="text-text-muted hover:text-terra-light transition-colors flex items-center gap-1">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
            Previous: AI/LLM
          </Link>
          <Link href={`/${locale}/tech-sovereignty/linux-foss`} className="text-text-muted hover:text-terra-light transition-colors flex items-center gap-1">
            Next: Linux/FOSS
