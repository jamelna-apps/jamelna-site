...
const CorePrinciple = () => (
  <div className="bg-canvas-raised border border-sky-500/30 rounded-xl p-6 mb-8">
...
const UDLSection = ({ udl }: { udl: UDLFramework }) => {
  ...
  return (
    <div className="bg-canvas-deep border border-sky-500/30 rounded-lg overflow-hidden">
        ...
        <div className="px-4 pb-4 space-y-4">
          <div className="bg-canvas-raised rounded-lg p-4 border border-sky-500/20">
            ...
            <div className="grid md:grid-cols-3 gap-3 text-xs">
              <div><p className="font-medium text-text-secondary mb-1">Choice & Autonomy</p><ul className="text-text-muted space-y-0.5">{udl.engagement.choiceAndAutonomy.map((item, i) => <li key={i} className="flex items-start gap-1"><span className="text-sky-400">•</span>{item}</li>)}</ul></div>
              <div><p className="font-medium text-text-secondary mb-1">Relevance</p><ul className="text-text-muted space-y-0.5">{udl.engagement.relevanceAndAuthenticity.map((item, i) => <li key={i} className="flex items-start gap-1"><span className="text-sky-400">•</span>{item}</li>)}</ul></div>
              <div><p className="font-medium text-text-secondary mb-1">Self-Regulation</p><ul className="text-text-muted space-y-0.5">{udl.engagement.selfRegulation.map((item, i) => <li key={i} className="flex items-start gap-1"><span className="text-sky-400">•</span>{item}</li>)}</ul></div>
            </div>
          </div>
          <div className="bg-canvas-raised rounded-lg p-4 border border-orange-500/20">
            ...
            <div className="grid md:grid-cols-3 gap-3 text-xs">
              <div><p className="font-medium text-text-secondary mb-1">Multiple Formats</p><ul className="text-text-muted space-y-0.5">{udl.representation.multipleFormats.map((item, i) => <li key={i} className="flex items-start gap-1"><span className="text-orange-400">•</span>{item}</li>)}</ul></div>
              <div><p className="font-medium text-text-secondary mb-1">Vocabulary Support</p><ul className="text-text-muted space-y-0.5">{udl.representation.vocabularySupport.map((item, i) => <li key={i} className="flex items-start gap-1"><span className="text-orange-400">•</span>{item}</li>)}</ul></div>
              <div><p className="font-medium text-text-secondary mb-1">Background Knowledge</p><ul className="text-text-muted space-y-0.5">{udl.representation.backgroundKnowledge.map((item, i) => <li key={i} className="flex items-start gap-1"><span className="text-orange-400">•</span>{item}</li>)}</ul></div>
            </div>
          </div>
          <div className="bg-canvas-raised rounded-lg p-4 border border-purple-500/20">
            ...
            <div className="grid md:grid-cols-3 gap-3 text-xs">
              <div><p className="font-medium text-text-secondary mb-1">Physical Options</p><ul className="text-text-muted space-y-0.5">{udl.actionExpression.physicalOptions.map((item, i) => <li key={i} className="flex items-start gap-1"><span className="text-purple-300">•</span>{item}</li>)}</ul></div>
              <div><p className="font-medium text-text-secondary mb-1">Expression Options</p><ul className="text-text-muted space-y-0.5">{udl.actionExpression.expressionOptions.map((item, i) => <li key={i} className="flex items-start gap-1"><span className="text-purple-300">•</span>{item}</li>)}</ul></div>
              <div><p className="font-medium text-text-secondary mb-1">Executive Function</p><ul className="text-text-muted space-y-0.5">{udl.actionExpression.executiveFunctionSupport.map((item, i) => <li key={i} className="flex items-start gap-1"><span className="text-purple-300">•</span>{item}</li>)}</ul></div>
            </div>
          </div>
        </div>
      )}
          ...
          {activity.videoResources && activity.videoResources.length > 0 && (
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-3">
              ...
              <div className="space-y-2">{activity.videoResources.map((video, i) => (
                <a key={i} href={video.url} target="_blank" rel="noopener noreferrer" className="block bg-canvas-raised rounded p-2 hover:bg-red-500/20 transition-colors border border-red-500/30">
    ...
    <div id={`${projectId}-lesson-${index + 1}`} className="bg-canvas-raised border border-canvas-border rounded-lg overflow-hidden scroll-mt-24">
      ...
      {expanded && (
        <div className="p-4 border-t border-canvas-border space-y-4">
          ...
          <div><h5 className="text-sm font-medium text-text-secondary mb-1">Learning Objectives</h5><ul className="text-sm text-text-muted space-y-1">{lesson.objectives.map((obj, i) => <li key={i} className="flex items-start gap-2"><span className="text-green-500 mt-1">✓</span>{obj}</li>)}</ul></div>
          {lesson.detailedActivities && lesson.detailedActivities.length > 0 ? (
            ...
            <div><h5 className="font-medium text-sky-300 mb-2">Activities</h5><ul className="list-disc list-inside text-sm text-text-secondary space-y-1">{lesson.activities.map((activity, i) => <li key={i}>{activity}</li>)}</ul></div>
          )}
          <div><h5 className="font-medium text-sky-300 mb-2">Materials</h5><ul className="list-disc list-inside text-sm text-text-secondary space-y-1">{lesson.materials.map((material, i) => <li key={i}>{material}</li>)}</ul></div>
        </div>
      )}
    </div>
  );
    ...
    {isExpanded && (
      <div className="p-6 border-t border-canvas-border space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-canvas-deep rounded-lg p-4"><h5 className="font-medium text-sky-300 mb-2">Required Materials</h5><ul className="list-disc list-inside text-sm text-text-secondary space-y-1">{project.materials.required.map((m, i) => <li key={i}>{m}</li>)}</ul></div>
          <div className="bg-canvas-deep rounded-lg p-4"><h5 className="font-medium text-sky-300 mb-2">Optional Materials</h5><ul className="list-disc list-inside text-sm text-text-secondary space-y-1">{project.materials.optional.map((m, i) => <li key={i}>{m}</li>)}</ul></div>
        </div>
        ...
        <div className="bg-canvas-deep rounded-lg p-4"><h4 className="font-semibold text-white mb-3">Assessment</h4><div className="grid md:grid-cols-2 gap-4"><div><h5 className="font-medium text-sky-300 mb-2">Formative Assessment</h5><ul className="list-disc list-inside text-sm text-text-secondary space-y-1">{project.assessment.formative.map((a, i) => <li key={i}>{a}</li>)}</ul></div><div><h5 className="font-medium text-sky-300 mb-2">Summative Assessment</h5><p className="text-sm text-text-secondary">{project.assessment.summative}</p></div></div></div>
    ...
    <main className="min-h-screen bg-canvas pt-16">
      <div className="bg-canvas-deep border-b border-canvas-border">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <Link href={`/${locale}/tech-sovereignty`} className="inline-flex items-center text-sm text-text-muted hover:text-sky-400 transition-colors">
      ...
      <div className="bg-canvas-deep border-t border-canvas-border">
        <div className="max-w-6xl mx-auto px-4 py-6 flex justify-between">
          <Link href={`/${locale}/tech-sovereignty/ai-llm`} className="text-text-muted hover:text-sky-400 transition-colors flex items-center gap-1">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
            Previous: AI/LLM
          </Link>
          <Link href={`/${locale}/tech-sovereignty/linux-foss`} className="text-text-muted hover:text-sky-400 transition-colors flex items-center gap-1">
            Next: Linux/FOSS
