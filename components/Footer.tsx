...
const Footer = () => {
  ...
  return (
    <footer className="bg-canvas-deep border-t border-canvas-border">
      {/* Photo mosaic strip */}
      <div className="flex h-20 overflow-hidden">
        {[
          '/photos/once-upon-a-time-in-new-york/1-DSCF2326.webp',
          '/photos/open-world/3-_DSF4266.webp',
          '/photos/out-there-somewhere/7-DSCF6091.webp',
          '/photos/once-upon-a-time-in-new-york/21-DSCF5980.webp',
          '/photos/open-world/15-DSCF5409.webp',
          '/photos/out-there-somewhere/19-DSCF6610.webp',
        ].map((src, i) => (
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="text-text-secondary hover:text-terra transition-colors text-sm inline-flex items-center gap-2"
                >
