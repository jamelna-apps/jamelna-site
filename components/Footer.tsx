  ...
  return (
    <footer className="bg-deep-footer border-t border-deep-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-5">
            <Link href={`/${locale}`} className="inline-block group">
              <h3 className="text-2xl font-display font-bold text-text-heading group-hover:text-accent transition-colors mb-2">
                JAMELNA
              </h3>
            </Link>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-text-primary/70 hover:text-accent transition-colors text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="text-text-primary/70 hover:text-accent transition-colors text-sm inline-flex items-center gap-2"
                >
        ...
        {/* Bottom Row */}
        <div className="mt-16 pt-8 border-t border-deep-border">
