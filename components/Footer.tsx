        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-5">
            <Link href={`/${locale}`} className="inline-block group">
              <h3 className="text-2xl font-display font-bold text-text-heading group-hover:text-warm transition-colors mb-2">
                JAMELNA
              </h3>
            </Link>
          ...
          <div className="md:col-span-3">
            <h4 className="text-xs font-mono text-warm uppercase tracking-wider mb-4">
              {t('navigate')}
            </h4>
