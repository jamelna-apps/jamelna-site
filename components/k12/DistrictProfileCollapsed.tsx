...
const DistrictProfileCollapsed: React.FC<DistrictProfileCollapsedProps> = ({
  ...
  return (
    <div className="bg-canvas-raised border border-ink/30 rounded-xl p-8 hover:border-ink/60 transition-all">
      ...
      <button
        ...
        className="inline-flex items-center text-ink font-medium hover:text-blue-300 transition-colors"
      >
        {labels.button}
